...
def main():
    ...
    with open(os.path.join("..", "robodk", os.path.join("..", "robodk", "path_original.json")), "w") as f:
    ...
    with open(os.path.join("..", "robodk", os.path.join("..", "robodk", "path_execution.json")), "w") as f:
